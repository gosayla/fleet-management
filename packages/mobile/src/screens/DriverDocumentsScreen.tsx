      ...
      return (
        ...
        >
          ...
          {!!item.referenceNumber && (
            <Text
              style={[styles.refText, { textAlign: !isRTL ? 'right' : 'left' }]}
              numberOfLines={1}
            >
              # {item.referenceNumber}
            </Text>
        ...
        >
          ...
          >
            <Text
              style={[
                styles.segBtnText,
                segment === 'mine' && styles.segBtnTextActive,
              ]}
            >
              {i18n.myDocs}
            </Text>
          ...
          <TouchableOpacity
            style={[
              styles.segBtn,
              segment === 'vehicle' && styles.segBtnActive,
            ]}
          ...
          >
            <Text
              style={[
                styles.segBtnText,
                segment === 'vehicle' && styles.segBtnTextActive,
              ]}
            >
              {i18n.vehicleDocs}
            </Text>
