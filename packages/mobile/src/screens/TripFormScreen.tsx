          ...
          <View style={styles.card}>
            <Field label={isAr ? 'تاريخ ووقت البداية' : 'Start Date & Time'} required>
              <TextInput
                ...
                onChangeText={v => set('scheduledStart', v)}
                placeholder="2026-05-10 08:00"
                placeholderTextColor={Colors.textMuted}
            ...
            <Field label={isAr ? 'تاريخ ووقت النهاية' : 'End Date & Time'} required>
              <TextInput
                ...
                onChangeText={v => set('scheduledEnd', v)}
                placeholder="2026-05-10 20:00"
                placeholderTextColor={Colors.textMuted}
                keyboardType="numbers-and-punctuation"
              />
            </Field>
