...
export function ProfileScreen({
  ...
  const animTopPad = scrollY.interpolate({
    inputRange: [0, COLLAPSE],
    outputRange: [SB_HEIGHT + 20, SB_HEIGHT + 14],
    extrapolate: 'clamp',
  });
  ...
  return (
    <View style={styles.container}>
      ...
      <Animated.View
        style={[
          styles.header,
          { height: animHeaderHeight, paddingTop: animTopPad },
        ]}
      >
        ...
        <Animated.View
          style={[
            styles.avatar,
            {
              width: animAvatarSize,
              height: animAvatarSize,
              borderRadius: 42,
              opacity: animAvatarOpacity,
            },
          ]}
        >
        ...
        <Animated.Text
          style={[styles.name, { fontSize: animNameSize }]}
          numberOfLines={1}
        >
          {displayName}
        </Animated.Text>
        ...
        <Animated.View
          style={[styles.subtitleWrap, { opacity: animSubtitleOpacity }]}
        >
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <InfoRow
            ...
            label={i18n.company}
            value={(user as any)?.companyName ?? (user as any)?.companyId ?? ''}
            last
            isRtl={isRtl}
          />
        </View>
        ...
        {onEditProfile && (
          ...
          >
            ...
            <Text style={styles.auditText}>{i18n.editProfile}</Text>
            <AppIcon
  ...
  return (
    ...
    >
      ...
      <View style={row.content}>
        ...
        <Text
          style={[row.value, isRtl && { textAlign: 'left' }]}
          numberOfLines={1}
        >
          {value || '—'}
        </Text>
